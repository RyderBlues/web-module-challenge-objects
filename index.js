...
*/
const Tacos = createMenuItem('Tacos', 2, 'Lunch');
const Pizza = createMenuItem('Pizza', 5, 'Dinner');
const Padthai = createMenuItem('Padthai', 10, 'Lunch');
console.log(Tacos);
console.log(Pizza);
console.log(Padthai);
...
*/
reviews.push({name: 'Ryder', rating: 5, feedback: 'sdfgfsdfsdfsdfgfsdfsdfsdfgfsdfsdfsdfgfsdfsdfsdfgfsdfsdfsdfgfsdfsdfsdfgfsdfsdfsdfgfsdfsdf'});
console.log(reviews);
